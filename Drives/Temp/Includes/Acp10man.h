...
*****************************************************************************
*                                                                           *
*            Header File for Library ACP10MAN (Version 2282)                * 
*                                                                           *
**************************** COPYRIGHT (C) **********************************
...
#define ACP10MAN_H_VERSION 0x2282 
...
typedef struct ACP10SAFEINDAT_typ {           /* SafeMC: SafeIN data */
   ...
   USINT              reserved_stat_b24;      /* reserved_stat_b24 */
   USINT              reserved_stat_b25;      /* reserved_stat_b25 */
...
typedef struct ACP10_HWIDRVCO_typ {           /* Hardware Information for drive component */
...
typedef struct ACP10_HWINFO_typ {             /* ACOPOS Hardware Information */
   ...
   USINT              reserve1;               /* Reserved */
   UINT               reserve2;               /* Reserved */
   ACP10_HWIDRVCO_typ drive;                  /* Drive */
   ACP10_HWIDRVCO_typ card[4];                /* Plug-in card */
   ACP10_HWIDRVCO_typ motor[2];               /* Motor */
} ACP10_HWINFO_typ;
