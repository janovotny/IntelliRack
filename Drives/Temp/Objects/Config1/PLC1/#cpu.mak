...
export AS_CPU_PATH_2 := C:/Users/florian/Google Drive/Schule/Projekt/Software/own/IntelliRack/Drives/Temp//Objects/$(AS_CONFIGURATION)/$(AS_PLC)
export AS_ACTIVE_CONFIG_PATH := $(AS_PROJECT_PATH)/Physical/$(AS_CONFIGURATION)/$(AS_PLC)
export AS_STATIC_ARCHIVES_PATH := C:/Users/florian/Google Drive/Schule/Projekt/Software/own/IntelliRack/Drives/Temp//Archives/$(AS_CONFIGURATION)/$(AS_PLC)
...
include $(AS_CPU_PATH)/drvman/drvman.mak
