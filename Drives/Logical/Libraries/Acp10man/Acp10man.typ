...
ACP10SAFEINDAT_typ : STRUCT                                 (* SafeMC: SafeIN data *)
   ...
   reserved_stat_b24    : USINT ;                           (* reserved_stat_b24 *)
   reserved_stat_b25    : USINT ;                           (* reserved_stat_b25 *)
...
END_STRUCT;
ACP10_HWIDRVCO_typ : STRUCT                                 (* Hardware Information for drive component *)
...
ACP10_HWINFO_typ : STRUCT                                   (* ACOPOS Hardware Information *)
   ...
   reserve1             : USINT ;                           (* Reserved *)
   reserve2             : UINT ;                            (* Reserved *)
   drive                : ACP10_HWIDRVCO_typ ;              (* Drive *)
   card                 : ARRAY [0..3] OF ACP10_HWIDRVCO_typ ;  (* Plug-in card *)
   motor                : ARRAY [0..1] OF ACP10_HWIDRVCO_typ ;  (* Motor *)
END_STRUCT;
