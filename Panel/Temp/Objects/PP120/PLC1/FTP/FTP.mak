UnmarkedObjectFolder := C:/Users/florian/Google Drive/Schule/Projekt/Software/own/IntelliRack/Panel/Logical/FTP/FTP
MarkedObjectFolder := C:/Users/florian/Google\ Drive/Schule/Projekt/Software/own/IntelliRack/Panel/Logical/FTP/FTP

$(AS_CPU_PATH)/FTP.br: \
	$(AS_PROJECT_PATH)/Physical/$(AS_CONFIGURATION)/$(AS_PLC)/Cpu.per \
	$(AS_CPU_PATH)/FTP/FTP.ox
	@"$(AS_BIN_PATH)/BR.AS.TaskBuilder.exe" "$(AS_CPU_PATH)/FTP/FTP.ox" -o "$(AS_CPU_PATH)/FTP.br" -v V1.00.0 -f "$(AS_CPU_PATH)/Global.ofs" -T SG4  -B V3.08 -extConstants -d "runtime: V* - V*,asieccon: V* - V*" -r Cyclic3 -p 2 -s FTP.FTP -L "AsARCfg: V*, AsIecCon: V*, asstring: V*, AsTCP: V*, AsTime: V*, FileIO: V*, Operator: V*, Runtime: V*, visapi: V*" -P "$(AS_PROJECT_PATH)/" -secret "$(AS_PROJECT_PATH)_br.as.taskbuilder.exe"
